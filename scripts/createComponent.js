...
rl.question('Veuillez entrer le nom du composant : ', (componentName) => {
  rl.question(
    'Veuillez entrer le dossier où placer le composant (components/pages): ',
    (folderChoice) => {
      rl.close();
      ...
      if (folderChoice !== 'components' && folderChoice !== 'pages') {
        console.error(
          "Choix invalide. Veuillez choisir entre 'components' ou 'pages'."
        );
        process.exit(1);
      }
        ...
        .catch(() => {
          ...
          fs.mkdir(componentDir)
            ...
            .then(() => {
              ...
              const scssFileName = `_${transformToCamelCase(
                componentName
              )}.scss`;
            ...
            .then((data) => {
              ...
              const importStatement = `@import '../${folderChoice}/${componentName}/${transformToCamelCase(
                componentName
              )}';\n`;
            ...
            .then(() => {
              console.log(
                `Le composant ${componentName} a été créé avec succès.`
              );
            })
            .catch((error) => {
